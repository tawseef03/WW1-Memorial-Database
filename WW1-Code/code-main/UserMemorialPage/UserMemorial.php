...
<head>
    ...
    <title>WW1 Memorial Records - User View</title>
    <link rel="icon" type="image/x-icon" href="../../../rsc/WebLogo.png">
    <link rel="stylesheet" href="../TotalCss/database.css">
    <link rel="stylesheet" href="userMemorial.css">
    <script src="userMemorial.js" defer></script>
</head>
<body>
    <div class="navbar">
        <div class="logo">
            ...
            <form id="searchForm">
                ...
                <div class="field-selector">
                    ...
                    <div class="checkbox-group">
                        ...
                        <label><input type="checkbox" name="fields" value="Cemetery/Grave Ref."> Grave Ref</label>
                        <label><input type="checkbox" name="fields" value="Cemetery / Memorial Country"> Country</label>
                        <label><input type="checkbox" name="fields" value="Memorial" checked> Memorial</label>
                        <label><input type="checkbox" name="fields" value="Memorial Location"> Location</label>
                        <label><input type="checkbox" name="fields" value="Memorial Info"> Info</label>
                        <label><input type="checkbox" name="fields" value="Memorial Postcode"> Postcode</label>
                        <label><input type="checkbox" name="fields" value="District" checked> District</label>
                        <label><input type="checkbox" name="fields" value="Photo available"> Photo</label>
                    </div>
