...
<div class="navbar">
        ...
        <div class="search-panel">
            ...
            <form id="searchForm" method="get">
                ...
                <div class="form-buttons">
                    ...
                    <button type="button" id="resetButton" onclick="window.location.href = 'AdminBiographies4.php';">Reset</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal" id="createRecordModal">
        <div class="modal-content">
            ...
            <form id="createRecordForm" action="process_record2.php" method="POST">
                ...
                <div class="form-buttons">
                    <button type="submit" class="submit-btn"   href="adminBiographies4.php" >Create Record</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal" id="editRecordModal">
        <div class="modal-content">
            ...
            <h2>Edit Record</h2>
            <form id="editRecordForm" action="process_record2.php" method="POST">
                ...
                <div class="form-buttons">
                    <button type="submit" class="submit-btn"  href="adminBiographies4.php">Update Record</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal" id="deleteConfirmModal">
        <div class="modal-content">
            ...
            <form id="deleteRecordForm" action="process_record2.php" method="POST">
                ...
                <div class="form-buttons">
                    ...
                    <button type="submit" class="delete-confirm-btn" href="adminBiographies4.php">Delete </button>
                </div>
            </form>
        </div>
    </div>
