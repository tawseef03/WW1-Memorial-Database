...
<head>
    ...
    <title>WW1 Newspaper Records - User View</title>
    <link rel="icon" type="image/x-icon" href="../../../rsc/WebLogo.png">
    <link rel="stylesheet" href="../TotalCss/database.css">
    <link rel="stylesheet" href="userNewspaper.css">
    <script src="userNewspaper.js" defer></script>
</head>
<body>
    <div class="navbar">
        <div class="logo">
    ...
    <div class="container">
        <div class="search-panel">
            ...
            <form id="searchForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="newspaper" name="newspaper" placeholder="Enter newspaper name...">
                </div>
                
                <div class="field-selector">
                    <h4>Display Fields</h4>
                    <div class="checkbox-group">
                        <label><input type="checkbox" name="fields" value="NewspaperID" checked> ID</label>
                        ...
                        <label><input type="checkbox" name="fields" value="ArticleDescription" checked> Article</label>
                        <label><input type="checkbox" name="fields" value="NewspaperName" checked> Newspaper</label>
                        <label><input type="checkbox" name="fields" value="PaperDate" checked> Date</label>
                        <label><input type="checkbox" name="fields" value="PageCol"> Page/Col</label>
                        <label><input type="checkbox" name="fields" value="PhotoIncl"> Photo</label>
                    </div>
        ...
        <div class="content-panel">
            <div class="database-title">
                <h2>Newspaper Records Search</h2>
            </div>
