<?php
// File: admin_test.php - Standalone test script (no PHPUnit)
...
class AdminTester
{
    ...
    public function __construct()
    {
        ...
        echo "Connected to ww1_test database successfully.\n";
    }
    ...
    public function runAllTests()
    {
        ...
        echo "-------------------------\n";
        echo "Tests Completed: " . ($this->testsPassed + $this->testsFailed) . "\n";
