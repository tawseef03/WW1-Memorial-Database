...
$total_query = "SELECT COUNT(*) FROM burials WHERE 1=1";
        ...
        <div class="search-panel">
            ...
            <form id="searchForm">
                ...
                <div class="form-buttons">
                    ...
                    <button type="button" id="resetButton" onclick="window.location.href = 'burial.html';">Reset</button>
                </div>
            </form>
        </div>
                ...
                <div class="display">
                    ...
                    if (empty($results)) {
                        ...
                        foreach ($results as $row) {
                            ...
                            echo "<p><strong>Info:</strong> " . htmlspecialchars($row['Info']) . "</p>";
                            echo "</div>";
                        }
                    }
                    ?>
